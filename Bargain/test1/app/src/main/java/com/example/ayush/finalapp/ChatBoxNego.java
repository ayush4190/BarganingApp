...
public class ChatBoxNego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InitializeFields();
//        displayMeet=findViewById(R.id.ChatAct_acceptmeet);
...
//                if(messagebox.getText().toString().compareToIgnoreCase("")==0){
...
//        group=findViewById(R.id.ChatAct_acceptmeet);
        ChatRoom =null;
    }
