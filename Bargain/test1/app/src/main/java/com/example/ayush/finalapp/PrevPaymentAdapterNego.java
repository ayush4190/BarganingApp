...
public class PrevPaymentAdapterNego extends RecyclerView.Adapter<PrevPaymentAdapterNego.PrevPaymentViewHolder> implements Serializable {
///
...
///
    ...
    public PrevPaymentAdapterNego.PrevPaymentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.previouspaymentcardnego, parent, false);
        return new PrevPaymentAdapterNego.PrevPaymentViewHolder(itemView);
    }


    //////////////////////////
    @Override
    public void onBindViewHolder(final PrevPaymentAdapterNego.PrevPaymentViewHolder holder, final int position) {
